...
function Engine_2({ history }) {
    ...
    async function get_data_engine() {
        ...
        set_engine_speed_chart({ series: [value_to_percent_engine_speed(get_json_data.data.result_m2.EngineSpeed).toFixed(0)], plotOptions: { radialBar: { dataLabels: { total: { label: `${get_json_data.data.result_m2.EngineSpeed} RPM` } } } } });
