...
function Engine_2() {
    ...
    async function get_data_engine() {
        ...
        set_tca((get_json_data.data.result_m2.TC_A).pad(5));
        set_tcb((get_json_data.data.result_m2.TC_B).pad(5));
        set_active_power((get_json_data.data.result_m2.PMU_KW).pad(5));

        set_engine_speed_chart({ series: [value_to_percent_engine_speed(get_json_data.data.result_m2.EngineSpeed.pad(3)).toFixed(2)], plotOptions: { radialBar: { dataLabels: { total: { label: `${get_json_data.data.result_m2.EngineSpeed} RPM` } } } } });
    ...
    return (
        <Fragment >
            <div style={{ padding: "10px" }}>
                <div class="side_nav" ref={nav_ref} style={{ backgroundColor: "#2141CA" }} >
