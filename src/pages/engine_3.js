...
function Engine_3() {
    ...
    async function get_data_engine() {
        ...
        set_tca((get_json_data.data.result_m3.TC_A).pad(5));
        set_tcb((get_json_data.data.result_m3.TC_B).pad(5));
        set_active_power((get_json_data.data.result_m3.PMU_KW).pad(5));
        ...
        set_control_air_chart({ series: [value_to_percent(get_json_data.data.result_m3.CtrlAir, 40)], plotOptions: { radialBar: { dataLabels: { total: { label: `${get_json_data.data.result_m3.CtrlAir} BAR` } } } } });
        set_charge_air_chart({ series: [value_to_percent(get_json_data.data.result_m3.ChargeAir, 6)], plotOptions: { radialBar: { dataLabels: { total: { label: `${get_json_data.data.result_m3.ChargeAir} BAR` } } } } });
        set_lt_water_chart({ series: [value_to_percent(get_json_data.data.result_m3.LT_Water, 6)], plotOptions: { radialBar: { dataLabels: { total: { label: `${get_json_data.data.result_m3.LT_Water} BAR` } } } } });
        set_ht_water_chart({ series: [value_to_percent(get_json_data.data.result_m3.HT_Water, 6)], plotOptions: { radialBar: { dataLabels: { total: { label: `${get_json_data.data.result_m3.HT_Water} BAR` } } } } });
        ...
        set_temp_avarenge_chart({
            series: [{
                ...
                data: [get_json_data.data.result_m3.ATempAverange, get_json_data.data.result_m3.BTempAverange]
        ...
        set_temp_after_chart({
            series: [{
                name: 'EXH. TEMP AFTER',
                data: [get_json_data.data.result_m3.ATempAfter, get_json_data.data.result_m3.BTempAfter]
        ...
        set_temp_before_chart({
            series: [{
                ...
                data: [get_json_data.data.result_m3.ATempBefore, get_json_data.data.result_m3.BTempBefore]
